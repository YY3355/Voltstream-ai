...
class ProductionMLForecaster:
    ...
    def __init__(self):
        self.hourly_mean = {
            0: 23.1, 1: 21.3, 2: 20.3, 3: 20.0, 4: 18.9, 5: 20.0,
            6: 20.9, 7: 19.4, 8: 15.0, 9: 17.8, 10: 20.7, 11: 26.2,
            12: 30.2, 13: 27.1, 14: 27.6, 15: 29.4, 16: 30.8, 17: 32.2,
            18: 30.8, 19: 36.5, 20: 40.9, 21: 42.9, 22: 36.1, 23: 26.6,
            24: 24.6,
        }
        self.hourly_std = {
            0: 1.4, 1: 1.4, 2: 0.9, 3: 1.6, 4: 1.8, 5: 2.5,
            6: 2.9, 7: 3.1, 8: 5.1, 9: 7.6, 10: 6.1, 11: 5.3,
            12: 7.1, 13: 6.5, 14: 5.8, 15: 6.6, 16: 9.7, 17: 9.9,
            18: 7.2, 19: 7.8, 20: 12.8, 21: 19.3, 22: 12.3, 23: 3.5,
            24: 1.9,
        }
        ...
        self.trained = True
        self.n_features = 49
        self.training_data = '480 real ERCOT intervals, May 14-18 2026'
